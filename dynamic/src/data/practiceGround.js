...
export class Game {
    constructor() {
        ...
        [
            ...
            new RigidBackground(0, 0).makeShape("Hex", { "x": 900, "y": 300, "rad": 50}),
            // new RigidBackground(0, 0).makeShape("Circle", { "x": 900, "y": 300, "rad": 100}),

            // new RigidBackground(0, 0, 30000).makeShape("Tri", { "x": 400, "y": 700, "width": 300, "height": 100, "dir":[1,1] }),
            ...
            .makeShape("Hex", { "x": 1000, "y": 100, "dir": [-1, 1], "rad": 50, "width": 25, "height": 25*3**0.5, "innerR": 20, "outerR": 45 }),
